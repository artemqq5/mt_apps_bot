...
CREATE TABLE `apps` (
  ...
  `bundle` char(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `campaigns` (
  ...
  `flow_id` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2024-04-17 13:42:22

...
# командный доступ (список доступа, удаление, изменение статуса, создание доступа) ===========================
...
# групповой доступ (активировать от пользователя) ======================================== "="
...
# команда (создать, список команд, удалить, изменить статус) ================================== ======================
